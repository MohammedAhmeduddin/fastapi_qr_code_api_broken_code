...
For this project, I resolved a specific number of errors introduced by the professor in the code and successfully fixed them. The objective of the project was to familiarize myself with running the project and understanding the steps the program follows to handle and process requests.
